function displayRecipe(response){
 ...
 let recipeOutput = document.querySelector("#recipe-output");
  ...
  recipeOutput.textContent = "⏳ Generating your recipe...";
    ...
    let context = "You are a professional chef and recipe developer. Provide clear and concise cooking instructions in no more than 8 lines. Provide each instruction on a new line and do not include the name of the recipe.";
